...
function AdminLogin({ onLoginSuccess, onSwitchRole }) {
    ...
    <div style={{ background: '#f4f6f8', minHeight: '100vh', display: 'flex', alignItems: 'center' }}>
      <div style={{ width: '100%', maxWidth: '400px', margin: '0 auto', padding: '20px' }}>
        <div className="card" style={{ textAlign: 'center' }}>
          ...
          <h2>Admin Login</h2>
          <p className="muted">System administration and user management</p>
          ...
          <button onClick={handleLogin} style={{ width: '100%', marginTop: '20px' }}>Login as Admin</button>

          <div style={{ marginTop: '20px', paddingTop: '20px', borderTop: '1px solid #eee' }}>
            <p className="muted" style={{ fontSize: '12px' }}>Demo: admin@medf.test / admin</p>
            <button
