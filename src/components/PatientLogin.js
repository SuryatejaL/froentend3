...
function PatientLogin({ onLoginSuccess, onSwitchRole }) {
    ...
    <div style={{ background: '#f4f6f8', minHeight: '100vh', display: 'flex', alignItems: 'center' }}>
      <div style={{ width: '100%', maxWidth: '400px', margin: '0 auto', padding: '20px' }}>
        <div className="card" style={{ textAlign: 'center' }}>
          ...
          <button onClick={handleLogin} style={{ width: '100%', marginTop: '20px' }}>Login as Patient</button>

          <div style={{ marginTop: '20px', paddingTop: '20px', borderTop: '1px solid #eee' }}>
            <p className="muted" style={{ fontSize: '12px' }}>Demo: bob@medf.test / patient</p>
            <button
